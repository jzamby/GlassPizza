...
public class PizzaMenuActivity extends Activity {
    ...
    private PizzaService.PizzaBinder mPizzaService;
    private boolean mResumed;

    private ServiceConnection mConnection = new ServiceConnection() {
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            if (service instanceof PizzaService.PizzaBinder) {
                mPizzaService = (PizzaService.PizzaBinder) service;
                openOptionsMenu();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(this, PizzaService.class), mConnection, 0);
    }
    ...
    public void openOptionsMenu() {
        if (mResumed && mPizzaService != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.stop:
                stopService(new Intent(this, PizzaService.class));
                return true;
            default:
